...
<body>
	...
	<div class="container">
		<h2 align="center">
			编辑学术讲座<a href="showAcademicLecture">(返回)</a>
		</h2>
		<form action="confrimEditAcademicLecture?id=${requestScope.r.id }"
		...
		<div>
			<form
				action="${pageContext.request.contextPath}/uploadAcademicLecture?id=${requestScope.r.id}"
