...
<body>
	...
	<div class="container">
		<h2 align="center">
			编辑学术讲座<a href="showAchievements">(返回)</a>
		</h2>
		<form action="confrimEditAchievements?id=${requestScope.r.id }"
		...
		<div>
			<form
				action="${pageContext.request.contextPath}/uploadAchievements?id=${requestScope.r.id}"
