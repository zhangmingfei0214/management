...
<body>
	...
	<div class="container">
		<h2 align="center">
			编辑鉴定成果<a href="showIdentificationResult">(返回)</a>
		</h2>
		<form
			action="confrimEditIdentificationResult?id=${requestScope.r.id }"
		...
		<div>
			<form
				action="${pageContext.request.contextPath}/uploadIdentificationResult?id=${requestScope.r.id}"
