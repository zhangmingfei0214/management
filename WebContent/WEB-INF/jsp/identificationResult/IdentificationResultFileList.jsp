...
<body>
	...
	<!-- 遍历Map集合 -->
	<div class="container">
	<h2 align="center">佐证文件列表<a href="showIdentificationResult">(返回)</a></h2>
		<c:forEach var="me" items="${fileNameMap}">
			<c:url value="downloadIdentificationResult" var="downurl">
				<c:param name="filename" value="${me.value}"></c:param>
			</c:url>
        ${me.key}<a href="${downurl}">下载</a>

			<c:if test="${user.type == 1}">
			<c:url value="deleteIdentificationResult" var="deleteurl">
