...
<body>
	...
	<div class="container">
		<h2 align="center">
			编辑研究报告<a href="showResearchReport">(返回)</a>
		</h2>
		<form action="confrimEditResearchReport?id=${requestScope.r.id }"
		...
		<div>
			<form
				action="${pageContext.request.contextPath}/uploadResearchReport?id=${requestScope.r.id}"
