...
<body>
	...
	<div class="container">
		<h2 align="center">
			专利成果<a href="showPatentResults">(返回)</a>
		</h2>
		<form action="confrimEditPatentResults?id=${requestScope.r.id }"
		...
		<div>
			<form
				action="${pageContext.request.contextPath}/uploadPatentResults?id=${requestScope.r.id}"
